...
func TestRenderPreview(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			t.Parallel()
			result := renderPreview(testutil.NewTestTheme(), session, tt.maxMessages, 80, "2006-01-02 15:04")
			assertContainsAll(t, result, tt.contains...)
			assertNotContainsAll(t, result, tt.excludes...)
		})
	}
...
func TestRenderPreviewSkipsHiddenSystemMessages(t *testing.T) {
	...
	result := renderPreview(testutil.NewTestTheme(), session, 10, 80, "2006-01-02 15:04")
...
func TestRenderPreviewHeader(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			t.Parallel()
			result := renderPreviewHeader(testutil.NewTestTheme(), tt.meta, "2006-01-02 15:04")
			assertContainsAll(t, result, tt.contains...)
			assertNotContainsAll(t, result, tt.excludes...)
		})
	}
