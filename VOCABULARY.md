...
| **Provider Reports** | A provider-keyed wrapper that aggregates one report per source backend, used for rebuild warnings such as drift and malformed raw data. |
